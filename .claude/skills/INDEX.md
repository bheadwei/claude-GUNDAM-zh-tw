...
| Skill | 用途 | 啟動時機 |
| :--- | :--- | :--- |
| **project-docs** | 依 VibeCoding 範本產專案文件（20 種範本自帶於 skill 的 `templates/`），支援 demo/mvp/full 三檔深度 | `/docs-init` 觸發（demo 產精簡 PRD、mvp 產 Tech Spec、full 產完整文件集），或手動要求寫 PRD/架構/API 規格 |
