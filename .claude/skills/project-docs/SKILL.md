---
name: project-docs
description: 依據 VibeCoding 工作流範本撰寫專案文件。涵蓋 PRD、架構設計、ADR、API 規範、WBS 等 16 種文件範本，支援 demo / mvp / full 三種深度模式。適用於需要產出專案文件、規劃文檔或技術規格時。
---
...
- 一份 `docs/tech-spec.md` 合併 02+05+06+08 的最小集合
