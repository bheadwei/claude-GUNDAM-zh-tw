...
| `sonnet`（8） | code-quality-specialist、tdd-guide、test-automation-engineer、e2e-validation-specialist、refactor-cleaner、deployment-expert、ui-builder、debug-investigator |
