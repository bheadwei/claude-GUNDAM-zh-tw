...
| Model | ID | Best For |
|-------|-----|----------|
| Opus 4.7   | `claude-opus-4-7`           | Complex reasoning, architecture, research |
...
Default to Sonnet 4.6 unless the task requires deep reasoning (Opus 4.7) or speed/cost optimization (Haiku 4.5). For production, prefer pinned snapshot IDs over aliases.
...
export ANTHROPIC_MODEL="claude-sonnet-4-6"  # or claude-opus-4-7, claude-haiku-4-5-20251001
```
